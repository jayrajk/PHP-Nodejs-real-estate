    ...
    <div class="container">
        ...
        <div class="col-md-5 col-sm-8  col-xs-12">
            ...
            <ul class="list-inline">
                <li><a class=" c-font-bold custom-color"><i class="fa fa-phone"></i> +1800138100 </a></li>
                <li class="c-divider"></li>
                <li><a class="c-font-uppercase c-font-bold custom-color"><i class="fa fa-envelope"></i> jkestate@company.com</a></li>
            </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse yamm" id="navigation">
            ...
            <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="property.html">Sell/Rent Property</a></li>
